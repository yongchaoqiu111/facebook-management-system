...
exports.timeout = exports.communicationMode = exports.healthCheckUrl = exports.outputSchema = exports.inputSchema = exports.description = exports.version = exports.name = exports.skillId = void 0;
...
class FacebookJoinGroups {
    constructor() {
        ...
        this.keywords = [];
        this.joinedGroups = [];
        this.cookiePath = path.join(currentDir, 'cookie', 'facebook.txt');
        this.keywordsPath = path.join(currentDir, 'skills', 'facebook_group_keywords.txt');
        this.loadKeywords();
    }
    loadKeywords() {
        try {
    ...
    async handleQuestions(groupName) {
        if (!this.page)
            return false;
        try {
            // 检查是否有问答对话框
    ...
    generateAnswer(groupName) {
        ...
        return answers[random_1.default.int(0, answers.length - 1)];
    }
    async joinGroup() {
        ...
        // 随机选择一个关键词
        const keyword = this.keywords[random_1.default.int(0, this.keywords.length - 1)];
...
// 导出技能
exports.skillId = 'mcp-weibo-facebook-join-groups';
exports.name = 'facebook-join-groups';
exports.version = '1.0.0';
exports.description = '自动加入Facebook小组，支持关键词搜索和问答处理';
exports.inputSchema = {
    type: 'object',
    properties: {
        email: {
...
exports.healthCheckUrl = '/health/facebook-join-groups';
exports.communicationMode = 'local-function';
exports.timeout = 300000; // 5分钟超时
// 创建技能实例
