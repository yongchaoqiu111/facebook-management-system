...
async function testFacebookImageUpload() {
  console.log('=== Facebook 图片上传测试 ===');
  console.log('说明：此脚本将直接查找并点击图片按钮，避免点击发文字贴文按钮');
  console.log('');
  ...
  try {
    ...
    if (hasCreatePostButton) {
      ...
      const imageButtonSelectors = [
        ...
        // 通过创建帖子按钮的子元素查找
        '[aria-label="创建帖子"]//*[contains(@aria-label, "照片")]',
        '[aria-label="创建帖子"]//*[contains(@aria-label, "视频")]'
      ];
...
testFacebookImageUpload().catch(console.error);